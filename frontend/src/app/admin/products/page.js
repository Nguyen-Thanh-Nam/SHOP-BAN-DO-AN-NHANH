                            ...
                            <table className="w-full text-left border-collapse">
                                <thead className="bg-gray-50/80 border-b border-gray-200 text-xs uppercase text-gray-500 font-semibold tracking-wider">
                                    <tr>
                                        ...
                                        <th className="p-6">Tên món ăn</th>
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {loading ? (
                                        ...
                                        currentData.map((item) => (
                                            ...
                                            >
                                                <td className="p-6">
                                                    <div className="w-16 h-16 rounded-xl overflow-hidden border border-gray-200 shadow-sm relative bg-gray-100">
                                                        <img
                                                            src={getImageUrl(
                                                                item.image
                                                            )}
                                                ...
                                                <td className="p-6">
                                                    ...
                                                    <div className="text-xs text-gray-400 mt-1 flex items-center gap-1">
                                                        ...
                                                        <span>
                                                            {item.category_id
                                                                ? `ID Danh mục: ${item.category_id}`
                                                                : "Chưa phân loại"}
                                                        </span>
                                                    </div>
                                                </td>
                                                <td className="p-6">
                                                    <div className="font-bold text-[#f48120] text-base">
                                                        {parseInt(
                                                            item.price
                                                        ).toLocaleString(
                                                            "vi-VN"
