        ...
        if (item.discount_type === "percent") {
            return (
                <span className="flex items-center gap-1 font-bold text-blue-600">
                    <Percent size={14} /> {item.discount_value}%
                </span>
            );
        }
        return (
            <span className="flex items-center gap-1 font-bold text-green-600">
                <DollarSign size={14} />{" "}
                {parseInt(item.discount_value).toLocaleString()}đ
            </span>
        );
    };
                                            ...
                                            >
                                                <td className="p-6">
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-10 h-10 rounded-lg bg-orange-50 flex items-center justify-center text-[#f48120] border border-orange-100">
                                                            <Ticket size={20} />
                                                        </div>
                                                        <div>
                                                            <div className="font-bold text-gray-800 text-base font-mono uppercase tracking-wide">
                                                                {item.code}
                                                            </div>
